...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\teleoperateur_app\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\teleoperateur_app\\public\\storage','logging.default','logging.deprecations.channel',
...
'password.request','password.email','password.reset','password.update','password.confirm','admin.users.index','admin.users.create','admin.users.store','admin.users.show',
'admin.users.edit','admin.users.update','admin.users.destroy','admin.dashboard','home',
'echantillons.index','echantillons.show','echantillons.next','echantillons.updateStatut','echantillons.refus',
'echantillons.appelEnCours','echantillons.demarrerAppel','echantillons.terminerAppel','rendezvous.index','rendezvous.entreprise',
'rendezvous.store','rendezvous.aujourdhui','suivis.index','suivis.store','suivis.creerRappel',
'telephones.store','telephones.updateStatus','telephones.getOrCreateForContact','contacts.store','emails.store',
'emails.update','emails.destroy','statistiques.index','api.echantillons.disponibles','storage.local',);
        registerArgumentsSet('views', 
'404','500','accordion','admin.dashboard.index','admin.users.index',
'alerts','aujourdhuiRDV','auth.login','auth.passwords.confirm','auth.passwords.email',
'auth.passwords.reset','auth.register','auth.verify','avatar','background',
'badge','blog','border','breadcrumbs','buttons',
'calendar','cards','carousel','chart-chartjs','chart-echart',
'chart-flot','chart-morris','chart-peity','chart-sparkline','chat',
'collapse','contacts','counters','darggablecards','display',
'dropdown','editprofile','empty','entreprise.show','entreprise.show1',
'entrepriseRDV','extras','faq','flex','forgot',
'form-advanced','form-editor','form-elements','form-layouts','form-validation',
'form-wizards','gallery','height','home','icons',
'image-compare','images','index','indexRDV','indexSuivi',
'invoice','layouts.app','layouts.footer','layouts.footer-scripts','layouts.head',
'layouts.main-header','layouts.main-sidebar','layouts.master','layouts.master2','layouts.models',
'layouts.sidebar','list-group','lockscreen','mail','mail-compose',
'mail-read','mail-settings','map-leaflet','map-vector','margin',
'media-object','modals','navigation','notification','padding',
'pagination','popover','position','pricing','product-cart',
'product-details','products','profile','progress','rangeslider',
'rating','reset','search','signin','signup',
'spinners','statistiques','sweet-alert','table-basic','table-data',
'tabs','tags','thumbnails','timeline','toast',
'todotask','tooltip','treeview','typography','underconstruction',
'userlist','welcome','widget-notification','widgets','width',
