...
<body>
    <div class="container mt-5">
            ...
            <div class="modal fade" id="addTelephoneModal" tabindex="-1" aria-labelledby="addTelephoneModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('telephones.store', $entreprise->id) }}" method="POST">
                            @csrf
            ...
            <div class="modal fade" id="createRendezVousModal" tabindex="-1" aria-labelledby="createRendezVousModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('rendezvous.store', $entreprise->id) }}" method="POST">
                            @csrf
                            <div class="modal-body">
                                <div class="mb-3">
        ...
        @else
            <div class="alert alert-warning">Aucune entreprise trouvée. Veuillez exécuter le seeder avec <code>php artisan db:seed</code>.</div>
        @endif
    </div>
